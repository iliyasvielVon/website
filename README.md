...
#全部内容都打包放进来了，除了资源文件别的都放进来了，B站是有api可以爬取的，抖音不允许机器爬取，只能人看，所以没让ai接着做了，
#说一下想法的，一方面是给作者维权，是准备把全网的优质作品整理下来，把搬运视频的也给附在对应页面上，快捷跳转里加上快速举报链接，
##另一方面是整理素材，让借用音乐的出处和使用频率以及使用场景对应到受观众喜爱程度，让作者做视频更方便一点，
##再有就是，有没有大佬做一下炸天帮徐缺啊，求求
